...
META_OVERRIDES = {
    "/טכנאי-מזגנים-גבעתיים/": {
        "meta_title": "טכנאי מזגנים בגבעתיים | תיקון והתקנה עם מחירון",
    },

    # --- pages that advertised the wrong town -----------------------------
    # Each was built by copying its neighbour, and the neighbour's name stayed
    # in the line a searcher reads before deciding whether to click.
    "/טכנאי-מזגנים-באור-עקיבא/": {
        "meta_title": "טכנאי מזגנים באור עקיבא | תיקון והתקנה עם מחירון",
    },
    "/טכנאי-מזגנים-בקדימה-צורן/": {
        "meta_description": "טכנאי מזגנים בקדימה צורן לתיקון והתקנה, בבתים פרטיים "
                            "ובדירות. מחירון מלא לפני מע\"מ, עבודה 24/7 ואחריות "
                            "על כל עבודה. חייגו 033820923.",
    },
    "/טכנאי-מזגנים-במודיעין/": {
        "meta_description": "טכנאי מזגנים במודיעין לתיקון והתקנת מזגנים. הגעה "
                            "מהירה, מחירון מלא לפני מע\"מ ואחריות מלאה על כל "
                            "עבודה. חייגו 033820923.",
    },

    # --- the category page duplicates the blog page in title and in purpose -
    "/category/בלוג/": {
        "meta_title": "ארכיון מאמרים | הבלוג של מיזוג פרו",
        "robots": "noindex, follow",
    },

    # --- titles that were being cut off in the results ---------------------
    # Over roughly 60 characters Google truncates, and it truncates the end -
    # which on this site was where the persuasive half lived.
    "/טכנאי-מזגנים-בבאר-שבע/": {
        "meta_title": "טכנאי מזגנים בבאר שבע | הגעה תוך שעה, בלי עלות נסיעה",
    },
    "/טכנאי-מזגנים-באור-יהודה/": {
        "meta_title": "טכנאי מזגנים באור יהודה | תיקון והתקנה עם מחירון",
        "meta_description": "טכנאי מזגנים באור יהודה לתיקון, התקנה וניקוי, "
                            "בבנייה ותיקה ובהתחדשות עירונית. מחירון מלא לפני "
                            "מע\"מ ואחריות מלאה.",
    },
    "/תיקון-מזגנים/": {
        "meta_title": "תיקון מזגנים בפריסה ארצית | מחירון ואחריות מלאה",
    },
    "/טכנאי-מזגנים-באלעד/": {
        "meta_title": "טכנאי מזגנים באלעד | מחירי תיקון והתקנה | מיזוג פרו",
    },
    "/מזגן-אינוורטר-חסרונות-ויתרונות/": {
        "meta_title": "מזגן אינוורטר: יתרונות וחסרונות | טבלת השוואה",
    },
    "/טכנאי-מזגנים-ברמת-גן/": {
        "meta_title": "טכנאי מזגנים ברמת גן | תיקון והתקנה | מיזוג פרו",
    },
    "/התקנת-מזגן-עילי/": {
        "meta_title": "התקנת מזגן עילי | פריסה ארצית עם אחריות מלאה",
    },
    "/טכנאי-מזגנים-צפון/": {
        "meta_title": "טכנאי מזגנים בצפון | תיקון והתקנה במחירים הוגנים",
    },
    "/מזגן-3-5-כוח-סוס/": {
        "meta_title": "מזגן 3.5 כוח סוס | מחירי התקנה ותיקון | מיזוג פרו",
    },
    "/התקנת-מזגן-1-כוח-סוס/": {
        "meta_title": "התקנת מזגן 1 כוח סוס | מחיר כולל התקנה ומחירון",
    },

    # --- descriptions that were being cut off ------------------------------
    "/טכנאי-מזגנים-בקריית-אונו/": {
        "meta_description": "טכנאי מזגנים בקריית אונו לתיקון והתקנה, בבניינים "
                            "ותיקים ובמגדלים חדשים. מחירון מלא לפני מע\"מ "
                            "ואחריות על כל עבודה. חייגו 033820923.",
    },
    "/התקנת-מזגן-vrf/": {
        "meta_description": "התקנת מזגן VRF לבתים ולעסקים: איך המערכת עובדת, "
                            "למי היא מתאימה ומה היא עולה. מחירון מלא לפני "
                            "מע\"מ ואחריות מלאה.",
    },
    "/מזגן-חצי-כוח-סוס/": {
        "meta_description": "מזגן חצי כוח סוס: לאיזה חדר הוא מתאים, כמה חשמל "
                            "הוא צורך ומה עולה ההתקנה. מחירון מלא לפני מע\"מ.",
    },
    "/ריח-רע-מהמזגן/": {
        "meta_description": "ריח רע מהמזגן: מאיפה הוא מגיע, מתי זה עובש ומתי "
                            "ניקוז חסום, ומה עולה הטיפול. מחירון לפני מע\"מ.",
    },
    "/thank-you/": {
